...
class TorchBaseNN(Base):
    ...
    def __init__(self, horizon: int, random_state: int, n_jobs: Optional[int], device: Optional[str] = None) -> None:
        super().__init__(horizon=horizon, random_state=random_state, n_jobs=n_jobs)
